...
public class VerticalWaveBullet : MonoBehaviour {
	...
	void Start () {
        ...
        {
            case 0:
                GetComponent<Rigidbody2D>().velocity = Vector2.right * 0.8f;
                break;
            case 1:
                GetComponent<Rigidbody2D>().velocity = Vector2.right * 0.2f;
                break;
            case 2:
                GetComponent<Rigidbody2D>().velocity = Vector2.right * 0.4f;
                break;
            case 3:
                GetComponent<Rigidbody2D>().velocity = Vector2.right * 0.6f;
                break;
        }
        ...
        if (parentNumber == 2 || parentNumber == 3)
        {
